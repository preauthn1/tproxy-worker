...
- 16 streams/session、12 MiB / 8192 items pending/session、每流有界有序 writer pump、单流 write deadline、256 KiB / 20 ms WINDOW 合并、closed-ID tombstones、WebSocket 断开时关闭所有 TCP sockets。
