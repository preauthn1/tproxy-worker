...
- `OPEN/DATA/CLOSE/WINDOW`、4 MiB 双向初始 credit、1 MiB frame payload、64 KiB relay chunks、严格递增且不复用的 stream ID。
- 16 streams/session、12 MiB / 8192 items pending/session、write deadline、closed-ID tombstones、WebSocket 断开时关闭所有 TCP sockets。
